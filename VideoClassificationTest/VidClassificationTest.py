# Followed Tutorial: https://keras.io/examples/vision/video_classification/
...
print(f"Total videos for eval: {len(eval_df)}")
...
def run_experiment():
    ...
    _, accuracy = seq_model.evaluate([eval_data[0], eval_data[1]], eval_labels)
...
sequence_model.save("video_model/")
